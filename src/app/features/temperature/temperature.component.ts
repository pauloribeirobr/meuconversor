...
export class TemperatureComponent implements OnInit {
  ...
  private async loadUnits(): Promise<void> {
    ...
    this.units = this.unitService.getUnitsByCategory('temperature');
    this.convert();
  }

  get fromUnitData(): Unit | undefined {
    return this.unitService.getUnitById('temperature', this.fromUnit);
  }

  get toUnitData(): Unit | undefined {
    return this.unitService.getUnitById('temperature', this.toUnit);
  }
