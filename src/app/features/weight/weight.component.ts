...
export class WeightComponent implements OnInit {
  ...
  private async loadUnits(): Promise<void> {
    ...
    this.units = this.unitService.getUnitsByCategory('weight');
    this.convert();
  }

  get fromUnitData(): Unit | undefined {
    return this.unitService.getUnitById('weight', this.fromUnit);
  }

  get toUnitData(): Unit | undefined {
    return this.unitService.getUnitById('weight', this.toUnit);
  }
