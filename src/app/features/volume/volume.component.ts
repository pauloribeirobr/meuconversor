...
export class VolumeComponent implements OnInit {
  ...
  fromUnit: string = 'liter';
  toUnit: string = 'cup-br';
  inputValue: number = 1;
  ...
  private async loadUnits(): Promise<void> {
    ...
    this.units = this.unitService.getUnitsByCategory('volume');
    this.convert();
  }

  get fromUnitData(): Unit | undefined {
    return this.unitService.getUnitById('volume', this.fromUnit);
  }

  get toUnitData(): Unit | undefined {
    return this.unitService.getUnitById('volume', this.toUnit);
  }
